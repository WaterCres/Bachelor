...
#TODO perhaps use standard unix error codes
...
def restrict_to_csv(res,path):
    output = {'nteams':[]}
# TODO calculate accurate capacities
...
def prepare_solver(selected, restrictions, compatibilities,scenario ):
    # TODO change this and add try: <code> except OSError as e: logger.error(<helpful message and timestamp>)
